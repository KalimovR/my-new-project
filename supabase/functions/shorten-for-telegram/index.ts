...
Твоя задача: сократить статью от 75 до 250 слов для Telegram.
...
=== ФОРМАТИРОВАНИЕ ТЕКСТА (где уместно) ===
...
- ||Скрытый текст|| — для шокирующих фактов или спойлеров ("Кто стоит за этим? ||Угадайте сами||")
